...
public class FileSweeper {
	...
	private final String BASE_PATH = "D:\\_mySpringProject\\_java\\_fileUpload\\";
	
	// 매일 정해진 시간에 스케줄러를 실행
	// 매일 등록된 파일과 (DB) <-> 해당 일자의 폴더에 있는 파일이 일치하느 파일은 남기고,
	// 일치하지 않은 파일이 있다면 삭제 (DB에는 없는데, 폴더에는 남아있는 파일이 있다면 삭제)
	// file.delete() - fileRomeveHandler를 사용하여 삭제해도 무방함.
	
	// 스케줄 기록 : cron  초 분 시 일 월 요일 년도 (년도는 생략가능)
	...
	public void fileSweeper() {
		...
		// D:\_mySpringProject\_java\_fileUpload\2024\11\04\\uuid_파일명
		// D:\_mySpringProject\_java\_fileUpload\2024\11\04\\uuid_th_파일명 => 이미지만 존재
		...
		// D:\_mySpringProject\_java\_fileUpload\2024\11\04 <- dir로 리턴
