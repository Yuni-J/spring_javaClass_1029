...
public class PagingHandler {
	...
	private int qty;  //한페이지에 나오는 페이지네이션 개수 : 10개 
	private int startPage;  //한페이지에 나오는 페이지네이션 시작번호 : 1 11 21 ... 181
	private int endPage;  //한페이지에 나오는 페이지네이션 끝번호 : 10 20 30 ... 181
	private boolean prev;  
	private boolean next;  
	
	private int totalCount; //전체 페이지 수 : DB에서 조회해 와야 하는 값.(매개변수로받아오기)
	private PagingVO pgvo;  //현재 페이지 번호 : pagingVO pageNo 사용. (매개변수로 반다오기)
